(function () {
    ...
    root.innerHTML = `
      ...
      <div class="retest-callout">
        <div class="retest-headline">
          ...
          but haven't been re-tested since <strong>${stats.stale_borked_cutoff_year || '—'}</strong> or earlier
        </div>
      ...
      <p class="meta">// Top borked games by report volume whose newest report is from ${stats.stale_borked_cutoff_year || '—'} or earlier.</p>
  ...
  function renderRatingsTrend(byYearRating) {
    ...
    // Legend with click-to-toggle would be nice but skip for now - always show all 5
    if (legend) {
