...
async function populateScoringTooltip(el) {
  ...
  container.innerHTML = `
    ...
    <div style="display:flex;flex-direction:column;gap:4px;margin-bottom:10px">
      <div style="display:flex;gap:8px;align-items:flex-start"><span style="font-size:10px;font-weight:700;padding:2px 7px;border-radius:3px;background:#b4c7dc;color:#111;flex-shrink:0">PLATINUM</span><span>Can install, start, and play. No faults. Works out of the box without any tinkering.</span></div>
      <div style="display:flex;gap:8px;align-items:flex-start"><span style="font-size:10px;font-weight:700;padding:2px 7px;border-radius:3px;background:#c8a050;color:#111;flex-shrink:0">GOLD</span><span>Can install, start, and play. No faults but required tinkering (launch options, config, etc).</span></div>
      <div style="display:flex;gap:8px;align-items:flex-start"><span style="font-size:10px;font-weight:700;padding:2px 7px;border-radius:3px;background:#8fa0b0;color:#111;flex-shrink:0">SILVER</span><span>Can install, start, and play. Exactly 2 faults (e.g. graphical + performance).</span></div>
      <div style="display:flex;gap:8px;align-items:flex-start"><span style="font-size:10px;font-weight:700;padding:2px 7px;border-radius:3px;background:#b07040;color:#fff;flex-shrink:0">BRONZE</span><span>Can install, start, and play. 3 or more faults. Playable but with significant issues.</span></div>
      <div style="display:flex;gap:8px;align-items:flex-start"><span style="font-size:10px;font-weight:700;padding:2px 7px;border-radius:3px;background:#c85050;color:#fff;flex-shrink:0">BORKED</span><span>Cannot install, cannot start, cannot begin playing, or overall verdict is No.</span></div>
    </div>

    <h4 style="margin:0 0 6px">Fault questions</h4>
    Each "Yes" to a fault question counts as 1 fault. Faults: performance, graphical, windowing, audio, input, stability, save game, significant bugs.<br><br>

    <h4 style="margin:0 0 6px">Out-of-the-box question</h4>
    Only shown when verdict is Yes and no faults are reported. Answering Yes elevates Gold to Platinum.<br><br>

    <h4 style="margin:0 0 6px">Quick reference</h4>
    <code>0 faults + out-of-box Yes = Platinum &nbsp;|&nbsp; 0 faults + out-of-box No = Gold &nbsp;|&nbsp; 1 fault = Gold &nbsp;|&nbsp; 2 faults = Silver &nbsp;|&nbsp; 3+ faults = Bronze &nbsp;|&nbsp; Can't play or verdict No = Borked</code><br><br>
    ...
    When submitting from the plugin, duration is pre-filled from your actual playtime. Time logged with the active config is weighted 1.25x over total Steam playtime -- hours with that exact setup matter more than lifetime hours across all configs.<br><br>
