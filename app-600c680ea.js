    ...
    <div class="card" id="${(() => { const id = r.reportId != null ? `r${r.reportId}` : (r.clientId ? `c${r.clientId.slice(0, 8)}` : ''); return id ? `report-${id}` : ''; })()}">
      ...
      <div class="right">
        <div class="card-rating-row">
          <span class="confidence-pill" title="Per-report confidence based on hardware match, recency, playtime, etc." style="background:${confColor(confPct / 10)};color:#0a0c10">Confidence: ${confPct}%</span>
      ...
      <div class="game-header">
        <div class="game-header-main">
          ...
          <div class="game-header-info">
            ...
            <!-- Steam Deck Verified row stays inline with the header summary
                 (it's status, not navigation). The boxed Steam/SteamDB/ProtonDB
                 link buttons below the tile cover external navigation -->
        ...
        <div class="game-header-side">
          ...
          <div class="game-header-actions">
            ...
            <button class="info-btn" id="min-reqs-btn" title="Minimum system requirements (from Steam Store, served by pipeline)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="14" rx="1"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="20" x2="15" y2="20"/></svg></button>
