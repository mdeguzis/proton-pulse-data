...
import { renderGamePage } from './components/game-page.js?v=322fe0e3';
import { renderHomePage } from './components/home.js?v=96564d6d';
import { renderSearchPage } from './components/search.js?v=c0b61bef';
