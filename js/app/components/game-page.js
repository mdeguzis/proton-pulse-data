...
import { enhanceAuthorBlocks } from './author.js?v=9aae4e4f';
...
import { renderCard } from './report-card.js?v=4561c9b8';
import { loadSearchIndex, searchIndex } from './search.js?v=5e2d7623';
