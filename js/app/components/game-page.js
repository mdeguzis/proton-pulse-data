...
import { enhanceAuthorBlocks } from './author.js?v=d0db3d64';
...
import { renderCard } from './report-card.js?v=3fac8a44';
import { loadSearchIndex, searchIndex } from './search.js?v=54ee1f1a';
