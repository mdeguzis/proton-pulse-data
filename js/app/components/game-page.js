...
import { enhanceAuthorBlocks } from './author.js?v=1e7f76f5';
...
import { renderCard } from './report-card.js?v=30d500da';
import { loadSearchIndex, searchIndex } from './search.js?v=8c86db5a';
