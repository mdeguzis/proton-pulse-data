...
import { enhanceAuthorBlocks } from './author.js?v=af82dcae';
...
import { renderCard } from './report-card.js?v=cd8e2950';
import { loadSearchIndex, searchIndex } from './search.js?v=64f6622d';
