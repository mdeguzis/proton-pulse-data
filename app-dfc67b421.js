...
function renderDeckStatusButton(appId) {
  ...
  return `<button class="info-btn deck-status-btn${disabledClass}" id="deck-status-btn" title="Steam Deck: ${label} (click for details)">
    <svg width="18" height="18" viewBox="0 0 24 24">${DECK_STATUS_ICON_SVG[status] || DECK_STATUS_ICON_SVG.unknown}</svg>
  </button>`;
}
